...
public class Hardware {
    ...
    public static String ServoStop, ServoPusherRight, ServoPusherLeft, ServoSpacers;

    public static String IMU, Color, Ultra, Lightone, Lighttwo, Touch, ContactLeft, IRDistance;
