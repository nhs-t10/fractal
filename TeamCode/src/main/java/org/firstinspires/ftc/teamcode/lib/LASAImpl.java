...
/**
 * Created by max on 11/1/16.
 */
public class LASAImpl extends VisionOpMode implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public LASAImpl() {
        ...
        hardwareMap = Hardware.getHardwareMap();
        openCVCamera = null;
    }
